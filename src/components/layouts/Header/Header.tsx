...
const Header = ({ className }: { className?: string }) => {
  ...
  return (
    <motion.header
      ...
      className={twMerge(
        "sticky top-0 z-20 w-full bg-zinc-950/70 backdrop-blur-md supports-[backdrop-filter]:bg-zinc-950/60 border-b border-zinc-800/40",
        className,
      )}
    >
      <div className="relative max-w-144 mx-auto flex justify-between md:justify-start px-3 py-10 md:gap-14 lg:gap-40">
        <img
          src={logo24}
